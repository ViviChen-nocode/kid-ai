    ...
    <div className="flex-1 flex flex-col items-center p-4 md:p-8">
      ...
      <div className="flex-1 w-full overflow-hidden flex items-center justify-center relative">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute left-4 top-1/2 -translate-y-1/2 h-14 w-14 rounded-full bg-card/90 backdrop-blur-sm shadow-lg hover:shadow-xl hover:bg-card border-2 border-border disabled:opacity-30 z-30 transition-all"
          onClick={(e) => {
            e.stopPropagation();
            goToPrevPage();
          }}
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute right-4 top-1/2 -translate-y-1/2 h-14 w-14 rounded-full bg-card/90 backdrop-blur-sm shadow-lg hover:shadow-xl hover:bg-card border-2 border-border disabled:opacity-30 z-30 transition-all"
          onClick={(e) => {
            e.stopPropagation();
            goToNextPage();
          }}
